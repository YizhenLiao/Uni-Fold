...
def load_single_feature(
    ...
    if "msa_species_identifiers" in msa_feature:
        del msa_feature["msa_species_identifiers"]
    if "msa_uniprot_accession_identifiers" in msa_feature:
        del msa_feature["msa_uniprot_accession_identifiers"]
    ...
    if uniprot_msa_feature_dir is not None:
        ...
        if "deletion_matrix_int" in all_seq_feature:
...
def load(
    ...
    if is_monomer:
        ...
        all_chain_features = pair_and_merge(all_chain_features, use_mmseqs_paired_msa)
